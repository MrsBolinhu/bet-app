                ...
                <div id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-secondaryDark text-primaryLight shadow">
                    <div id="tabs" className="flex justify-between p-1">
                        <a href="/" className="w-full focus:text-teal-500 hover:text-indigo-600 justify-center inline-block text-center pt-2 pb-1">
                            ...
                            <span className="tab tab-home block text-xs text-primaryLight">Home</span>
                        </a>
                        <a href="ranking" className="w-full focus:text-teal-500 hover:text-indigo-600 justify-center inline-block text-center pt-2 pb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block mb-1">
                            ...
                            <span className="tab tab-kategori block text-xs text-primaryLight">Ranking</span>
                        </a>
                        {!isAdmin &&
                            <a href="/bets" className="w-full focus:text-teal-500 hover:text-indigo-600 justify-center inline-block text-center pt-2 pb-1">
                                <svg width="25" height="25" viewBox="0 0 42 42" className="inline-block mb-1">
                                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                ...
                                <span className="tab tab-whishlist block text-xs text-primaryLight">Bets</span>
                            </a>
                        }
                        <a href='/account' className="w-full focus:text-teal-500 hover:text-indigo-600 justify-center inline-block text-center pt-2 pb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block mb-1">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>

                            <span className="tab tab-account block text-xs text-primaryLight">Account</span>
                        </a>
                    </div>
                </div>
            }
